    ...
    <div style={{ background: "#0f172a", borderRadius: "24px", border: "1px solid var(--glass-border)", padding: "32px", boxShadow: "0 15px 35px rgba(0,0,0,0.15)", minHeight: "560px", color: "#fff", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center" }}>
      ...
      {waData.isReady ? (
        ...
        <div style={{ width: "100%", maxWidth: "420px" }}>
          {waData.qrCodeUrl ? (
            <div style={{ background: "#ffffff", padding: "16px", borderRadius: "20px", display: "inline-block", margin: "0 auto 20px auto", boxShadow: "0 10px 30px rgba(0,0,0,0.3)" }}>
              <img src={waData.qrCodeUrl} alt="WhatsApp QR Code" style={{ width: "240px", height: "240px", display: "block" }} />
            </div>
          ) : (
            <div style={{ margin: "30px auto" }}>
              {loading ? <div className="spinner" style={{ margin: "0 auto" }}></div> : <p style={{ color: "#94a3b8" }}>Generating secure QR code...</p>}
            </div>
          )}
          <div style={{ textAlign: "left", background: "#1e293b", border: "1px solid #334155", borderRadius: "14px", padding: "16px", fontSize: "13px", color: "#cbd5e1", lineHeight: "1.7", marginBottom: "20px" }}>
            <b style={{ color: "#38bdf8" }}>📱 How to link ScrapVex WhatsApp Business:</b><br/>
